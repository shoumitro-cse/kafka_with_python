...
#df = spark.readStream .format("kafka").option("kafka.bootstrap.servers", "0.0.0.0:9092").option("subscribe", "topic_1") .option("delimeter",",").option("startingOffsets", "earliest").load()
